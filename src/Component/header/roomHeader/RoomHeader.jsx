              ...
              <div className=" w-[100%]  border-b-[1.5px]  py-[px] flex ms-center">
                <div className=" flex w-[75%]  2xl:w-[1370px]  items-center justify-between  gap-[10px] mx-auto">
                  ...
                  <div className="relative w-fit flex gap-[10px] justify-center items-center h-fit p-[3.5px] border-[1px] border-[#cbcbcb] rounded-[7px] my-[10px] text-[#000] bg-[#ffffff]">
                    ...
                    <div
                      className={`absolute top-0 left-0 h-[40px] mt-[2.8px] w-[100px] rounded-[6px] bg-[#F59E0B] transition-transform duration-300 ease-in-out`}
                      style={{
                        transform:
                          activeButton === "Tours"
                            ? "translateX(3px)"
                    ...
                    <button
                      className={`relative z-10 flex w-[100px] text-[14px] rounded-[6px] p-[9px] text-center justify-center items-center ${
