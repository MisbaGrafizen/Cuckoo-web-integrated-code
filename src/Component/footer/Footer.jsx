...
const Footer = forwardRef((props, ref) => {
  ...
  return (
    <>
      ...
      <footer ref={ref} className="bg-[#071a2d] font-Poppins text-white pt-[50px] md:pb-[20px] pb-[80px]  px-6 md:px-12">
        <div className="md:max-w-[92%] mx-auto flex flex-col">
          <div className=" flex md:flex-row flex-col   gap-[20px] w-[100%] justify-between">
            <div className=" flex flex-col ">
              ...
              {/* <div className=' flex  py-[15px] flex-col gap-[10px] '>
                <h1 className=' font-[600]'>
                  Follow us
                </h1>
                <div className=' text-[#fff] text-[20px]  flex gap-[10px] items-center'>
                ...
                <ul className="  flex flex-col gap-[px]">
                  ...
                  <li>
                    <a
                      ...
                      className="text-gray-400 hover:text-white  cursor-pointer text-[14px] font-[300]" onClick={handleAbout}
                    >
                      About Us
                    </a>
                  </li>
 ...
 Terms & Conditions 
                ...
                <ul className=" flex flex-col gap-[px]">
                  <li>
                    <a
                      ...
                      className="text-gray-400 hover:text-white cursor-pointer text-[14px] font-[300]"
                    >
                      Contact Us
                    </a>
                  </li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center border-t border-gray-700 pt-6">
            <div className="flex flex-wrap justify-between w-[100%] gap-4 md:mb-0">
              ...
              <div className=' text-[#fff]  text-[23px]  flex gap-[20px] items-center'>

        
                  <i class="fa-brands cursor-pointer fa-instagram"></i>
                  <i class="fa-brands cursor-pointer fa-facebook-f"></i>
                  <i class="fa-brands cursor-pointer fa-youtube"></i>
                  <i class="fa-brands cursor-pointer fa-x-twitter"></i>
                  <i class="fa-brands cursor-pointer fa-linkedin-in"></i>
                </div>
            </div>
