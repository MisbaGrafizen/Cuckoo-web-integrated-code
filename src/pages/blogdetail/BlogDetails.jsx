...
export default function BlogDetails() {
    return (
        <>
        <div>
            <div className="2xl:w-[1400px] font-Poppins !bg-[#] w-[90%] md:w-[75%] pt-[160px] pb-[40px] flex flex-col gap-[0px] h-[100%] mx-auto px-2 py-8">
                {/* Hero Banner */}
                ...
                <article className="space-y-5">
                    <h1 className="text-[18px] md:text-3xl font-bold text-gray-900">
                    ...
                    <section>
                        <h2 className=" text-[18px] md:text-2xl font-bold text-gray-900 mb-4">Why Choose Cuckoo Travel?</h2>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900 md:text-[16px] text-[14px]">Seamless Travel Planning:</h3>
                    ...
                    <section>
                        <h2 className=" text-[18px] md:text-2xl font-bold text-gray-900 mb-4">Exclusive Travel Packages</h2>
                        <p className="text-gray-700 md:text-[16px] text-[14px]">
                    ...
                    <section>
                        <h2 className=" text-[18px] md:text-2xl font-bold text-gray-900 mb-4">Luxury and Comfort</h2>
                        <p className="text-gray-700 md:text-[16px] text-[14px]">
                    ...
                    <section>
                        <h2 className=" text-[18px] md:text-2xl font-bold text-gray-900 mb-4">Safety and Reliability</h2>
                        <p className="text-gray-700 md:text-[16px] text-[14px]">
